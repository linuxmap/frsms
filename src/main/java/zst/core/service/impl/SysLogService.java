...
public class SysLogService implements ISysLogService{
	...
	public HSSFWorkbook createExcel(List<SysLog> logs) throws Exception {
	    ...
	    // 设置列宽 
	    sheet.setColumnWidth((short) 0, (short) (25 * 100));
	    sheet.setColumnWidth((short) 1, (short) (35 * 100));
	    sheet.setColumnWidth((short) 2, (short) (35 * 100));
	    sheet.setColumnWidth((short) 3, (short) (40 * 100));
	    sheet.setColumnWidth((short) 4, (short) (100 * 100));
	    sheet.setColumnWidth((short) 5, (short) (45 * 100));
	    // 在sheet中添加表头第0行 
	    ...
	    if (CollectionUtil.isNotEmpty(logs)) {
	    	for (int i = 0; i < logs.size(); i++) {
	    		...
	    		HSSFCell c3 = row.createCell((short) 2);//操作人
	    		c3.setCellStyle(style1); 
	    		c3.setCellValue(sysLog.getUserName()); 
	    		
	    		HSSFCell c4 = row.createCell((short) 3);//平台
	    		...
	    		HSSFCell c5 = row.createCell((short) 4);//日志描述
	    		c5.setCellStyle(style1); 
	    		c5.setCellValue(sysLog.getOperatorDesc()); 
	    		
	    		HSSFCell c6 = row.createCell((short) 5);//操作时间
